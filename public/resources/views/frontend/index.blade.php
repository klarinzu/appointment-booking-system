...
<body>
    ...
    <div class="container">
        <div class="booking-container">
            <div class="booking-header">
                <h2><i class="bi bi-calendar-check"></i> Room Cleaning Booking</h2>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body text-center p-4">
                    ...
                    <h4 class="mt-3">Damo nga Salamat!</h4>
    ...
    <script id="booking-data" type="application/json">
        {!! json_encode(['categories' => $categories, 'employees' => $employees]) !!}
    </script>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            const bookingData = bookingDataEl ? JSON.parse(bookingDataEl.textContent || '{}') : {};
            const categories = bookingData.categories || [];
        ...
        `;
            ...
            const employees = bookingData.employees || [];
    ...
    @auth
    <div id="ai-chat-widget" style="position:fixed;bottom:20px;right:20px;width:320px;max-width:90vw;background:#fff;border:1px solid #dee2e6;border-radius:8px;box-shadow:0 10px 30px rgba(0,0,0,0.12);z-index:1050;font-size:14px;">
        <div style="display:flex;align-items:center;justify-content:space-between;padding:8px 10px;border-bottom:1px solid #dee2e6;">
            <strong>AI Assistant</strong>
            <button id="ai-chat-toggle" type="button" style="border:none;background:transparent;font-size:16px;line-height:1;">−</button>
        </div>
        <div id="ai-chat-body" style="padding:10px;display:block;">
            <div id="ai-chat-log" style="height:200px;overflow-y:auto;margin-bottom:8px;padding:8px;border:1px solid #f1f1f1;border-radius:6px;background:#fafafa;"></div>
            <textarea id="ai-chat-input" rows="3" placeholder="Ask something about your booking..." style="width:100%;resize:none;padding:8px;border:1px solid #ced4da;border-radius:6px;margin-bottom:8px;"></textarea>
            <button id="ai-chat-send" type="button" class="btn btn-primary w-100">Send</button>
        </div>
    </div>
        ...
        (() => {
            ...
            const submit = async () => {
                ...
                try {
                    ...
                    append('AI', data.reply || data.error || 'There was a problem getting a reply.');
                } catch (e) {
                    append('AI', 'There was a problem sending your message.');
                } finally {
                    sending = false;
                    send.disabled = false;
                    input.focus();
