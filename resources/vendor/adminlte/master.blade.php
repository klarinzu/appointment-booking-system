...
<head>
    ...
    {{-- Favicon --}}
    @if(config('adminlte.favicon'))
        <link rel="icon" type="image/png" href="{{ asset(config('adminlte.favicon')) }}">
        <link rel="apple-touch-icon" href="{{ asset(config('adminlte.favicon')) }}">
...
<body class="@yield('classes_body')" @yield('body_data')>
    ...
    <footer class="main-footer @if(Route::is('login','register','password.confirm','password.update','password.reset','password.request')) mx-auto mt-5 @endif">
        ...
        <span class="d-block d-sm-inline">Leyte Normal University | Office of the Vice-President for Student Development</span>
        <div class="float-right d-none d-sm-inline-block">
            <b>Service</b> Student Transactions and Appointments
        </div>
    </footer>
